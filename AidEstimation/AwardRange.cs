...
namespace Ucsb.Sa.FinAid.AidEstimation
{
    ...
    public class AwardRange
    {
        ...
        {
            return GetRangeFromValue(value, buffer, buffer);
        }
        ...
        /// either of the range values are negative, they will be set to zero
        /// </summary>
        public static AwardRange GetRangeFromValue(double value, double lowerBuffer, double upperBuffer)
        {
            ...
            return new AwardRange(value - lowerBuffer, value + upperBuffer);
        }
