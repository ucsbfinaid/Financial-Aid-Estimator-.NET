    ...
    public partial class Independent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                CostOfAttendanceEstimator coaEstimator = CostOfAttendanceEstimatorConfigurationManager.GetCostOfAttendanceEstimator("2223");
                ...
                percentageGrantOutput.Text = ConfigurationManager.AppSettings["PercentageGrant.Independent.2223"];
