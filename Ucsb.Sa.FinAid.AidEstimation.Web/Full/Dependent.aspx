...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <p>
        ...
        that will be offered by an institution. All estimated values are <strong>subject to the
            ...
            <ul>
                ...
                <li>
                    <fieldset>
                        ...
                        <asp:RadioButtonList runat="server" ID="inputFirstParentWorking" RepeatLayout="UnorderedList">
                ...
                <li>
                    <fieldset>
                        ...
                        <asp:RadioButtonList runat="server" ID="inputSecondParentWorking" RepeatLayout="UnorderedList">
                ...
                <li>
                    <fieldset>
                        ...
                        <asp:RadioButtonList runat="server" ID="inputIsStudentWorking" RepeatLayout="UnorderedList">
                ...
                <li>
                    <fieldset>
                        ...
                        <asp:RadioButtonList runat="server" ID="inputAreParentsTaxFilers" RepeatLayout="UnorderedList">
                ...
                <li>
                    <fieldset>
                        ...
                        <asp:RadioButtonList runat="server" ID="inputIsStudentTaxFiler" RepeatLayout="UnorderedList">
